...
note: you will also need to provide SENDGRID_KEY=key if you chose that option during the initial setup, I would advise not to choose this option unless you know how to use it.  If you get an app error when starting the app in Heroku this could be the issue and you can retroactively fix it by going to Heroku dashboard -> Settings -> reveal Config Vars and then add SENDGRID_KEY=key in two new boxes.  You can also see the other keys here.
